...
const PostingCard = ({id, employer, employerIng, location, title, type, salary, createdAt} : Posting) => {
  return (
    <a href='' className='m-4'>
      <div className='flex flex-row bg-gray-200 w-[23rem] rounded-2xl px-8 py-6 gap-4 items-center hover:scale-[1.02] hover:bg-gray-300'>
        <img src={employerIng} alt={employer} width={64} />
        <div>
